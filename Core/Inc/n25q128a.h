...
#define N25Q128A_SR_PRBOTTOM                                                   \
  ((uint8_t)0x20) /*!< Protected memory area defined by BLOCKPR starts from    \
                     top or bottom */
...
#define N25Q128A_NVCR_LOCK                                                     \
  ((uint16_t)0x0001) /*!< Lock nonvolatile configuration register */
...
#define N25Q128A_FSR_VPPERR                                                    \
  ((uint8_t)0x08) /*!< Invalid voltage during program or erase */
